...
<div class="modal fade" id="update_line_<?= $value->id_line; ?>" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('admin/update_line', array('id' => 'form-update-line' . $value->id_line)); ?>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control name_area" id="name_area<?= $value->id_line; ?>"
                        name="name_area" placeholder="Enter Code Line" value="<?= $value->name_area; ?>" readonly>
                </div>
                <div class="form-group">
