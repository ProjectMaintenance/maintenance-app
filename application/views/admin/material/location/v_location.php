    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">
                    <a href="<?= site_url('admin/add_location') ?>" class="btn btn-primary"><i
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="upload_location"
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-info" data-toggle="modal"
                                    data-target="#updatelocation<?= $value->id_location; ?>">
                                    <i class="fas fa-edit mr-2"></i>Edit
                                </button>
                                <button type="button" class="btn btn-danger" id="delete_location"
                                    data-id-location="<?= $value->id_location; ?>"
                                    data-code-location="<?= $value->code_location; ?>"><i
...
<div class="modal fade" id="updatelocation<?= $value->id_location; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <?= form_open('admin/update_location', array('id' => 'form-update-location' . $value->id_location)); ?>
            <div class="card-body">
                <div class="form-group">
                    <input type="hidden" name="id_location" class="form-control"
                        id="id_location<?= $value->id_location; ?>" value="<?= $value->id_location; ?>" readonly>
                </div>
                <label for="code_location">Code location</label>
                <div class="form-group">
                    <input type="text" name="code_location" class="form-control"
                        id="code_location<?= $value->id_location; ?>" value="<?= $value->code_location; ?>">
                </div>
                <label for="name_location">Name location</label>
                <div class="form-group">
                    <input type="text" name="name_location" class="form-control"
                        id="name_location<?= $value->id_location; ?>" value="<?= $value->name_location; ?>">
                </div>
            </div>
            <!-- /.card-body -->
