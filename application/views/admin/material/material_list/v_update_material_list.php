        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="code_uom" name="code_uom" placeholder="Code Uom"
                        readonly value="<?= $material->code_uom ?>">
                    <input type="text" class="form-control" id="name_uom" name="name_uom" placeholder="Name UOM"
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="code_location" name="code_location"
                        placeholder="Code Location" readonly value="<?= $material->code_location ?>">
                    <input type="text" class="form-control" id="name_location" name="name_location"
                        placeholder="Name Location" readonly value="<?= $material->name_location ?>">
                </div>
                <div class="form-group">
            ...
            <div class="card-footer">
                <a type="button" class="btn btn-danger" href="<?= base_url('admin/material_list') ?>"" name="
