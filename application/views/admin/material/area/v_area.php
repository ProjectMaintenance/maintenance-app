...
<div class="modal fade" id="updatearea<?= $value->id_area; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('admin/update_area', array('id' => 'form-update-area' . $value->id_area)); ?>
            <div class="card-body">
                ...
                <div class="form-group">
                    <input type="text" name="code_area" class="form-control" id="code_area<?= $value->id_area; ?>"
                        placeholder="Enter Code Category" value="<?= $value->code_area; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="name_area" class="form-control" id="name_area<?= $value->id_area; ?>"
