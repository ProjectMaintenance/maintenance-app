        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <form action="<?= site_url('admin/save_req_order'); ?>" id="form-add-req-order" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <a class="btn btn-primary mb-3" href="<?= site_url('admin/add_material_for_req_order');  ?>"><i class="fas fa-plus mr-2"></i>Add Material
                                List</a>
                        ...
                        <div class="card-footer">
                            <a type="button" class="btn btn-danger" href="<?= base_url('admin/req_order') ?>" name=" btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
