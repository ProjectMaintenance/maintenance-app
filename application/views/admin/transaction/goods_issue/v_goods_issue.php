...
<div class="modal fade" id="update_gi<?= $value->id_transaction; ?>" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open('admin/update_goods_issue', array('id' => 'form-update-gr' . $value->id_transaction)); ?>
            <div class="card-body">
...
$(document).ready(function() {
    ...
    $('#update_gi<?= $value->id_transaction; ?>').on('shown.bs.modal', function() {
        ...
        $('#area<?= $value->id_transaction; ?>').change(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= site_url('admin/get_line_by_area'); ?>",
                data: {
                    code_area: code_area
                },
                dataType: "JSON",
        ...
        $('#line<?= $value->id_transaction; ?>').change(function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "<?= site_url('admin/get_machine_by_line'); ?>",
                data: {
                    code_line: code_line
                },
                dataType: "JSON",
