    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">
                    <a href="<?= site_url('admin/add_goods_receive') ?>" class="btn btn-primary"><i
                            class="fas fa-plus mr-2"></i>Add Goods Receive</a>
                </h2>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-info" data-toggle="modal"
                                    data-target="#update_gr<?= $value->id_transaction; ?>">
...
<div class="modal fade" id="update_gr<?= $value->id_transaction; ?>" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('admin/update_goods_receive', array('id' => 'form-update-gr' . $value->id_transaction)); ?>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="price" <?= $value->id_transaction; ?> name="price"
                        placeholder="Enter Price" value="<?= $value->price; ?>">
                </div>
                <div class="form-group">
        ...
        $("#tbl_transaction").DataTable({
            ...
            "buttons": [{
                    ...
                    exportOptions: {
                        ...
                        8], // Indeks kolom yang ingin dicetak
                    },
                },
                {
                    extend: "print",
