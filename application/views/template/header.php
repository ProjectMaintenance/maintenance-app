...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>plugins/datatables-select/css/select.bootstrap4.min.css">
    <link rel="stylesheet" href="<?= base_url('assets/template/') ?>plugins/datatables-scroller/css/scroller.bootstrap4.min.css">
    <!-- Toastr -->
