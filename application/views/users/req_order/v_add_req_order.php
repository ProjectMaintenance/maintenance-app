        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <form action="<?= site_url('users/save_req_order'); ?>" id="form-add-req-order" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="register_no" name="register_no" placeholder="Enter Register No" value="">
                                    </div>
                                    <div class="form-group">
                                        <label for="date">Date Required</label>
                                        <input type="date" class="form-control" id="date_required" name="date_required" value="<?= date('Y-m-d'); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category_item_service" name="category_item_service" placeholder="Enter Category Item/Service">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="level_of_request" name="level_of_request" placeholder="Enter Level Of Request">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form group">
                                        ...
                                        <input class="form-control" type="text" name="requester_name" id="requester_name" placeholder="Masukan Requester name">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form group">
                                        ...
                                        <input class="form-control" type="text" name="pic_maintenance" id="pic_maintenance" placeholder="PIC Maintenance">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form group">
                                        <label for="manager_maintenance">Approved By Manager</label>
                                        <input class="form-control" type="text" name="manager_maintenance" id="manager_maintenance" placeholder="Manager Maintenance" value="AZWAR R.W.N">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form group">
                                        <label for="g_manager_maintenance">Approved By G.Manager</label>
                                        <input class="form-control" type="text" name="g_manager_maintenance" id="g_manager_maintenance" placeholder="General Manager Maintenance" value="FAHMI ARIEF">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form group">
                                        <label for="approved_by">Received By</label>
                                        <input class="form-control" type="text" name="approved_by" id="approved_by" placeholder="Received By">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <a class="btn btn-primary mb-3" href="<?= site_url('users/add_material_for_req_order');  ?>"><i class="fas fa-plus mr-2"></i>Add Material
                                List</a>
                        ...
                        <div class="card-footer">
                            <a type="button" class="btn btn-danger" href="<?= base_url('users/req_order') ?>" name=" btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#department').change(function(e) {
            ...
            $.ajax({
                url: '<?= site_url('users/generate_no_ppbj'); ?>', // Replace with the URL to your PHP function
                type: 'POST',
                data: {
        ...
        // Function to set the level of request based on date difference
        ...
        $('#form-add-req-order').validate({
            rules: {
                register_no: {
                    required: true,
                    // remote: {
                    //     url: "<?= site_url('users/check_register_no') ?>",
                    //     type: "POST",
                    //     data: {
