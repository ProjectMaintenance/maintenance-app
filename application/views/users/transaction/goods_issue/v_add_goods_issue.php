    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="identity_pic" id="identity_pic">
                        <option value="" selected>- Select Name Requester -</option>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" value="<?= $id_transaction; ?>" id="id_transaction"
            ...
            <div class="card-footer">
                <a type="button" class="btn btn-danger" href="<?= base_url('users/goods_issue') ?>"" name="
...
$(document).ready(function() {
    ...
    $('#area').change(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= site_url('users/get_line_by_area'); ?>",
            data: {
                code_area: code_area
            },
            dataType: "JSON",
    ...
    $('#line').change(function(e) {
        ...
        $.ajax({
            type: "GET",
            url: "<?= site_url('users/get_machine_by_line'); ?>",
            data: {
                code_line: code_line
            },
            dataType: "JSON",
