...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('admin/save_update_material', array('id' => 'form-update-material')); ?>
            <div class="card-body">
                <?php foreach ($data_material as $material) : ?>
                    <input type="hidden" class="form-control" id="id_material" name="id_material" placeholder="Material Code" readonly value="<?= $material->id_material ?>">
                    <div class="form-group">
                        <label for="code_material">Material Code</label>
                        <input type="text" class="form-control" id="code_material" name="code_material" placeholder="Material Code" readonly value="<?= $material->code_material ?>">
                    </div>
                    <div class="form-group">
                        <label for="code_material">Category</label>
                        <input type="hidden" class="form-control" id="category" name="category" placeholder="Category" readonly value="<?= $material->code_category ?>">
                        <input type="text" class="form-control" id="name_category" name="name_category" placeholder="Category" readonly value="<?= $material->name_category ?>">
                    </div>
                    <div class="form-group">
                        <label for="part_name">Part Name</label>
                        <input type="text" class="form-control" id="part_name" name="part_name" placeholder="Enter Part Name" value="<?= $material->part_name ?>">
                    </div>
                    <div class="form-group">
                        <label for="part_type">Model / Part Type</label>
                        <input type="text" class="form-control" id="part_type" name="part_type" placeholder="Enter Model / Part Type" value="<?= $material->part_type ?>">
                    </div>
                    <div class="form-group">
                        <label for="part_number_maker">Part Number Maker</label>
                        <input type="text" class="form-control" id="part_number_maker" name="part_number_maker" placeholder="Enter Part Number Maker" value="<?= $material->part_number_maker ?>">
                    </div>
                    <div class="form-group">
                        <label for="part_code_machine">Part Code Machine</label>
                        <input type="text" class="form-control" id="part_code_machine" name="part_code_machine" placeholder="Enter Part Code Machine" value="<?= $material->part_code_machine ?>">
                    </div>
                    <div class="form-group">
                        <label for="part_drawing">Part Drawing</label>
                        <input type="text" class="form-control" id="part_drawing" name="part_drawing" placeholder="Enter Part Drawing" value="<?= $material->part_drawing ?>">
                    </div>
                    <div class="form-group">
                        <label for="maker">Maker</label>
                        <input type="text" class="form-control" id="maker" name="maker" placeholder="Enter Maker" value="<?= $material->maker ?>">
                    </div>
                    <div class="form-group">
                        <label for="additional_description">Additional Description</label>
                        <input type="text" class="form-control" id="additional_description" name="additional_description" placeholder="Enter Additional Description" value="<?= $material->additional_description ?>">
                    </div>
                    <div class="form-group">
                        <label>Area</label>
                        <select class="form-control select2" id="area" name="area" style="width: 100%;">
                        </select>
                        <input type="hidden" class="form-control" id="code_area" name="code_area" placeholder="Code Area" readonly value="<?= $material->code_area ?>">
                        <input type="text" class="form-control" id="name_area" name="name_area" placeholder="Name Area" readonly value="<?= $material->name_area ?>">
                    </div>
                    <div class="form-group">
                        <label>Line</label>
                        ...
                        <input type="hidden" class="form-control" id="code_line" name="code_line" placeholder="Code Line" readonly value="<?= $material->code_line ?>">
                        <input type="text" class="form-control" id="name_line" name="name_line" placeholder="Name Line" readonly value="<?= $material->name_line ?>">
                    </div>
                    <div class="form-group">
                        <label>Machine</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantity_on_machine" name="quantity_on_machine" placeholder="Enter Quantity On Machine" value="<?= $material->qty_on_machine ?>">
                    </div>
                    <div class="form-group">
                        <label for="quantity_stock">Quantity Stock</label>
                        <input type="number" class="form-control" id="quantity_stock" name="quantity_stock" placeholder="Enter Quantity Stock" value="<?= $material->qty_stock ?>">
                    </div>
                    <div class="form-group">
                        <label>Uom</label>
