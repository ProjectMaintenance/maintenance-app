...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('users/save_machine', array('id' => 'form-add-machine')) ?>
            <div class="card-body">
            ...
            <a type="button" class="btn btn-danger" href="<?=base_url('users/machine')?>"" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?= site_url('users/add_machine'); ?>",
            dataType: "JSON",
            success: function(response) {
                ...
                $('#area').change(function(e) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('users/add_machine'); ?>", // Perbaikan: Gunakan controller yang benar
                        type: "GET",
                        dataType: "JSON",
                        data: {
                            code_area: code_area
