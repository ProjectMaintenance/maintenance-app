    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                $menu_open  = '';
                $active     = '';
                if (uri_string() == 'users/material_list' || uri_string() == 'users/add_material_list' || uri_string() == 'users/update_material_list/' . $params || uri_string() == 'users/category' || uri_string() == 'users/add_category' || uri_string() == 'users/area' || uri_string() == 'users/add_area' || uri_string() == 'users/line' || uri_string() == 'users/add_line' || uri_string() == 'users/machine' || uri_string() == 'users/add_machine' || uri_string() == 'users/uom' || uri_string() == 'users/add_uom' || uri_string() == 'users/location' || uri_string() == 'users/add_location' || uri_string() == 'users/detail_material_list') {
                    $menu_open = 'menu-open';
                    $active    = 'active';
                }
                ?>
                <li class="nav-item <?= $menu_open; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <?php
                        $params = $this->uri->segment(3);
                        $material_list = (uri_string() == 'users/material_list' || uri_string() == 'users/add_material_list' || uri_String() == 'users/update_material_list/' . $params) ? 'active' : ''; ?>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('users/detail_material_list') ?>"
                ...
                <li class="nav-item <?= $menu_open; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('users/history_transaction') ?>"
