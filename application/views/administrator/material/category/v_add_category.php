...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('administrator/save_category', array('id' => 'form-add-category')); ?>
            <div class="card-body">
                <div class="form-group">
                    <input type="text" name="code_category" class="form-control" id="code_category"
                        placeholder="Enter Code Category" value="<?= set_value('code_category') ?>">
                </div>
                <div class="form-group">
            ...
            <a type="button" class="btn btn-danger" href="<?=base_url('administrator/category')?>"" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
