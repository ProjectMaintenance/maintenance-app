...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php if ($this->session->flashdata('msg_code_material')) { ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert"
            style="background-color: #d4edda; color: #155724; border-color: #c3e6cb">
            Code Material <strong><?= $this->session->flashdata('msg_code_material'); ?></strong> Saved
            Successfuly
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('administrator/save_material', array('id' => 'form-add-material')); ?>
            <div class="card-body">
            ...
            <div class="card-footer">
                <a type="button" class="btn btn-danger" href="<?= base_url('administrator/material_list') ?>"" name="
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#area').change(function(e) {
                ...
                $.ajax({
                    url: "<?php echo base_url('administrator/add_material_list'); ?>",
                    type: "GET",
                    dataType: "JSON",
                    data: {
                        code_area: code_area
