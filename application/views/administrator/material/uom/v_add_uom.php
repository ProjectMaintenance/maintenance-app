...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('administrator/save_uom', array('id' => 'form-add-uom')) ?>
            <div class="card-body">
            ...
            <a type="button" class="btn btn-danger" href="<?=base_url('administrator/uom')?>"" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
