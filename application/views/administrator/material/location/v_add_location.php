...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <?= form_open('administrator/save_location', array('id' => 'form-add-location')) ?>
            <div class="card-body">
                <div class="form-group">
                    <label for="code_location">Code Location</label>
                    <input type="text" class="form-control" id="code_location" name="code_location"
                        placeholder="Enter Code location">
                </div>
                <div class="form-group">
            ...
            <a type="button" class="btn btn-danger" href="<?=base_url('administrator/location')?>"" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
