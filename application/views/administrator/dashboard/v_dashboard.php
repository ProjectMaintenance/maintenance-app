                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="<?= site_url('administrator/goods_issue') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box" style="background-color: burlywood">
                            ...
                            <a href="<?= site_url('administrator/history_transaction') ?>" class="small-box-footer">More
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-primary">
                            ...
                            <a href="<?= site_url('administrator/manage_user') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="small-box" style="background-color: #ffeb84">
                            ...
                            <a href="<?= site_url('administrator/req_order') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
