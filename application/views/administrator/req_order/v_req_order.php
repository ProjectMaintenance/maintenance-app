    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">
                    <a href="<?= site_url('administrator/add_req_order') ?>" class="btn btn-primary"><i class="fas fa-plus mr-2"></i>Add Request Order Material</a>
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                    ...
                                    Update Jugdment
                                        ...
                                        <a href="<?= site_url('administrator/update_req_order/' . $value->regist_no); ?>" class="btn btn-info">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank" href="<?= site_url('administrator/print_req_order/' . $value->regist_no); ?>" class="btn btn-info"><i class="fas fa-print mr-2"></i> Print Req Order</a>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).on('click', 'button[data-id-req-order]', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= site_url('administrator/delete_req_order') ?>',
                        data: {
                            id_req_order: id_req_order,
                            regist_no: regist_no
                        },
