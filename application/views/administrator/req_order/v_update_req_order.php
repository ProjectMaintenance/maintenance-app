        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    <form action="<?= site_url('administrator/save_update_req_order'); ?>" id="form-add-req-order" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="regist_no" id="regist_no" class="form-control" value="<?= $data_req_order->regist_no; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="register_no">Register No</label>
                                        <input type="text" class="form-control" id="register_no" name="register_no" placeholder="Enter Register No" value="<?= $data_req_order->register_no; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="date">Date Required</label>
                                        <input type="date" class="form-control" id="date_required" name="date_required" value="<?= $data_req_order->date_required; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="category_item_service" name="category_item_service" placeholder="Enter Category Item/Service" value="<?= $data_req_order->category_item_service; ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="b3_product" id="b3_product">
                                            ...
                                            <option value="YES" <?= $data_req_order->b3_product == "YES" ? "selected" : "" ?>>YES
                                            </option>
                                            <option value="NO" <?= $data_req_order->b3_product == "NO" ? "selected" : "" ?>>NO</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="reason" name="reason" placeholder="Enter Reason" value="<?= $data_req_order->reason; ?>">
                                    </div>
                                    <div class="form-group">
                                        <!-- <label for="date_created">Date Created</label> -->
                                        <input type="hidden" class="form-control" name="date_created" id="date_created" value="<?= date('Y-m-d'); ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="level_of_request">Level Of Request</label>
                                        <input type="text" class="form-control" id="level_of_request" name="level_of_request" placeholder="Enter Level Of Request" value="<?= $data_req_order->level_of_request; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="type_of_payment">Type Of Payment</label>
                                        <select class="form-control" name="type_of_payment" id="type_of_payment">
                                            <option value="" <?= $data_req_order->type_of_payment == "" ? "selected" : "" ?>>- Select
                                                Type Of Payment -</option>
                                            <option value="SUSPEND" <?= $data_req_order->type_of_payment == "SUSPEND" ? "selected" : "" ?>>
                                                SUSPEND</option>
                                            <option value="REIMBUES" <?= $data_req_order->type_of_payment == "REIMBUES" ? "selected" : "" ?>>
                                                REIMBUES</option>
                                            <option value="DUE PAYMENT" <?= $data_req_order->type_of_payment == "DUE PAYMENT" ? "selected" : "" ?>>
                                                DUE PAYMENT</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="order_type" id="order_type">
                                            ...
                                            <option value="FEASIBILITY STUDY" <?= $data_req_order->order_type == "FEASIBILITY STUDY" ? "selected" : "" ?>>
                                                FEASIBILITY STUDY</option>
                                            <option value="ORDER" <?= $data_req_order->order_type == "ORDER" ? "selected" : "" ?>>ORDER
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="attachment">Attachment</label>
                                        <select class="form-control select2" multiple="multiple" name="attachment[]" id="attachment" placeholder="Select Attachment">
                                            <?php
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="requester_name" id="requester_name" placeholder="Masukan Alasan Pembelian" value="<?= $data_req_order->requester_name; ?>">
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="pic_maintenance" id="pic_maintenance" placeholder="PIC Maintenance" value="<?= $data_req_order->created_by_pic; ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="manager_maintenance">Approved By Manager</label>
                                        <input class="form-control" type="text" name="manager_maintenance" id="manager_maintenance" placeholder="Manager Maintenance" value="<?= $data_req_order->approved_by_manager; ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="g_manager_maintenance">Approved By G.Manager</label>
                                        <input class="form-control" type="text" name="g_manager_maintenance" id="g_manager_maintenance" placeholder="General Manager Maintenance" value="<?= $data_req_order->approved_by_general_manager; ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="approved_by">Received By</label>
                                        <input class="form-control" type="text" name="approved_by" id="approved_by" placeholder="Approved By" value="<?= $data_req_order->approved_by; ?>">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <br>
                            <hr>
                            <button type="button" class="btn btn-primary btn-add-row mb-3"><i class="fas fa-plus mr-2"></i>Add Jasa</button>
                        ...
                        <div class="card-footer">
                            <a type="button" class="btn btn-danger" href="<?= base_url('administrator/req_order') ?>" name=" btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
...
<script>
    $(document).ready(function() {
        ...
        var selectedMaterialTable = $('#selected_material_table').DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                "url": "<?= site_url('administrator/get_list_material_req_order_by_regist_no'); ?>",
                "type": "POST",
                "data": function(d) {
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        if (data === null) {
                            return '<input type="number" class="form-control quantity" name="quantity[]" placeholder="Enter quantity" min="1" style="width: 75px;">';
                        } else {
                        ...
                        if (response.success == true) {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    "<?= site_url('administrator/req_order'); ?>";
